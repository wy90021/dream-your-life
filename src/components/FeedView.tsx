    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow">
      ...
      <div className="p-4">
        <blockquote
          ...
          data-instgrm-permalink={`https://www.instagram.com/reel/${item.instagramEmbedId}/?utm_source=ig_embed&utm_campaign=loading`}
        ...
        >
          <div style={{ padding: '16px' }}>
            <a
              href={`https://www.instagram.com/reel/${item.instagramEmbedId}/?utm_source=ig_embed&utm_campaign=loading`}
              style={{
                background: '#FFFFFF',
                lineHeight: 0,
                padding: 0,
